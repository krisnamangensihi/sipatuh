                                                            ...
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        @foreach ($sosialdocs as $sosialdoc)
                                                                            <tr>

                                                                                <td class="pe-1">
                                                                                    {{ $sosialdoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                        <a href="{{ asset('storage/' . $sosialdoc->document) }}"
