                    ...
                    <div class="mb-1 breadcrumb-right">
                        {{-- <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                {{-- <a class="dropdown-item" href="/bogorkeamanantw1"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 1</span></a>
                                <a class="dropdown-item" href="/bogorkeamanantw2"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 2</span></a>
                                <a class="dropdown-item" href="/bogorkeamanantw3"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 3</span></a>
                                <a class="dropdown-item" href="/bogorkeamanantw4"><i class="me-1"
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <a href="/rekapbogor" class="btn btn-bitbucket btn-md " target="blank">Generated Level</a>
                        <a href="/cetakbogor" class="btn btn-success btn-md " target="blank">Cetak Formulir</a>
                    </div>
                </div>
            </div>
            <br>
