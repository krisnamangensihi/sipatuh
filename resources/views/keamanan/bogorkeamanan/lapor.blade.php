                                                            ...
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        @foreach ($lapordocs as $lapordoc)
                                                                        <tr>
                                                                                    
                                                                                <td class="pe-1">{{ $lapordoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                <a href="{{ asset('storage/' . $lapordoc->document) }}" target="blank">document <i data-feather="file"></i> </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
