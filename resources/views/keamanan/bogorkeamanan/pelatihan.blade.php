                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>: {{ $pelatihan->no_kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="pe-1">Kriteria</td>
                                                                            <td>:
                                                                                {{ $pelatihan->sub_kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        @foreach ($pelatihandocs as $pelatihandoc)
                                                                        <tr>
                                                                                    
                                                                                <td class="pe-1">{{ $pelatihandoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                <a href="{{ asset('storage/' . $pelatihandoc->document) }}" target="blank">document <i data-feather="file"></i> </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
                                                                            <td class="pe-1">Catatan</td>
                                                                            <td>: {{ $pelatihan->catatan }}
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
