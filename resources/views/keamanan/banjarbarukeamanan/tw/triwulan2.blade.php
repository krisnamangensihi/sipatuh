                    ...
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="/cetakbanjarbaru"target="blank"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Cetak Pdf</span></a>
                                <a class="dropdown-item" href="/banjarbarukeamanantw1"target="blank"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 1</span></a>
                                <a class="dropdown-item" href="/banjarbarukeamanantw2"target="blank"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 2</span></a>
                                <a class="dropdown-item" href="/banjarbarukeamanantw3"target="blank"><i class="me-1"
                                        data-feather="check-square"></i><span class="align-middle">Triwulan 3</span></a>
                                <a class="dropdown-item" href="/banjarbarukeamanantw4"target="blank"><i class="me-1"
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <a href="/rekapbanjarbarutw2" class="btn btn-primary btn-md " target="blank">Generated Level</a>
                    </div>
                </div>
            </div>
            <br>
