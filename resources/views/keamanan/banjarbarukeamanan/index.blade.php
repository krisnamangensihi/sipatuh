                    ...
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="/cetakbogor"
                                ...
                                <a class="dropdown-item" href="/rekapbanjarbaru" target="blank"><i
                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    @foreach ($kepemimpinans as $kepemimpinan)
                                        <tr>
                                            <td></td>
                                            <td class="text-justify"><strong>{{ $kepemimpinan->no_kriteria }}</strong></td>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <a href="/rekapbanjarbaru" class="btn btn-bitbucket btn-md " target="blank">Generated Level</a>
                        <a href="/cetakbanjarbaru" class="btn btn-success btn-md " target="blank">Cetak Formulir</a>
                    </div>
                </div>
            </div>
            <br>
