            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <form action="/padangkeamanan/{{ $kepemimpinan->id }}/edit">
                            @if ($kepim->triwulan == '1')
                            ...
                            @foreach ($kepemimpinans as $verifikasi)
                                @if ($verifikasi->verifikasi == 'tw1')
                                    <a href="/rekappadangtw1" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw2')
                                    <a href="/rekappadangtw2" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw3')
                                    <a href="/rekappadangtw3" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw4')
                                    <a href="/rekappadangtw4" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                    {{-- @elseif ($verifikasi->verifikasi == 'tw3')
                                    <span class="badge rounded-pill  badge-light-warning">revisi</span>
                                @elseif ($verifikasi->verifikasi == 'tw4')
