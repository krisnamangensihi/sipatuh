            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <a href="/rekapjakarta" class="btn btn-bitbucket btn-md " target="blank">Generated Level</a>
                        <a href="/cetakjakarta" class="btn btn-success btn-md " target="blank">Cetak Formulir</a>
                    </div>
                </div>
            </div>
            <br>
