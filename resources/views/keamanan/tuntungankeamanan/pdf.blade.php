...
<body>
    <div>
        <img class="logo" width="100px" src="{{ public_path('/app-assets/images/pages/patuh123.png') }}"
            alt="">
        <div>
            {{-- @foreach ($leadership as $le) --}}

            <p class="text-center m-0 text-uppercase" style="font-size: 18px">LAPORAN KEPATUHAN KEAMANAN</p>
            <p class="text-center m-0" style="font-size: 18px">Seluruh Data Tabel</p>
