            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <form action="/kikeamanan/{{ $kepemimpinan->id }}/edit">
                            @if ($kepim->triwulan == '1')
                                <input type="hidden" value="tw1" name="tw" />
                            @elseif ($kepim->triwulan == '2')
                                <input type="hidden" value="tw2" name="tw" />
                            @elseif ($kepim->triwulan == '3')
                                <input type="hidden" value="tw3" name="tw" />
                            @elseif ($kepim->triwulan == '4')
                                <input type="hidden" value="tw4" name="tw" />
                            @endif
                            <button class="btn btn-success"
                                onclick="return confirm('Apakah anda yakin ingin memverifikasi?')">Verifikasi</button>
                            @foreach ($kepemimpinans as $verifikasi)
                                @if ($verifikasi->verifikasi == 'tw1')
                                    <a href="/rekapkantorinduktw1" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw2')
                                    <a href="/rekapkantorinduktw2" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw3')
                                    <a href="/rekapkantorinduktw3" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw4')
                                    <a href="/rekapkantorinduktw4" class="btn btn-primary btn-md " target="blank">Generated
                                        Level</a>
                                    {{-- @elseif ($verifikasi->verifikasi == 'tw3')
                                    <span class="badge rounded-pill  badge-light-warning">revisi</span> --}}
                                    {{-- @elseif ($verifikasi->verifikasi == 'tw4') --}}
