                        ...
                        <form action="/kikeamanan/{{ $kepemimpinan->id }}/edit">
                            ...
                            @foreach ($kepemimpinans as $verifikasi)
                                @if ($verifikasi->verifikasi == 'tw1')
                                    <a href="/rekapkantorinduktw1" class="btn btn-primary btn-md "
                                        target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw2')
                                    <a href="/rekapkantorinduktw2" class="btn btn-primary btn-md "
                                        target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw3')
                                    <a href="/rekapkantorinduktw3" class="btn btn-primary btn-md "
                                        target="blank">Generated
                                        Level</a>
                                @elseif ($verifikasi->verifikasi == 'tw4')
                                    <a href="/rekapkantorinduktw4" class="btn btn-primary btn-md "
                                        target="blank">Generated
                                        Level</a>
                                    {{-- @elseif ($verifikasi->verifikasi == 'tw3')
                                    <span class="badge rounded-pill  badge-light-warning">revisi</span> --}}
