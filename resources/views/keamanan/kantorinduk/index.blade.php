                    ...
                    {{-- <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="/cetakbogor"
                                ...
                                <a class="dropdown-item" href="/rekapjakarta" target="blank"><i
                                        class="me-1"data-feather="check-square"></i><span class="align-middle">Generated
                                        Level</span></a>
                            </div>
                        </div>
                    </div> --}}
                                    ...
                                    @foreach ($kepemimpinans as $kepemimpinan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/kepemimpinan/{{ $kepemimpinan->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                ...
                                <tbody>
                                    @foreach ($sosials as $sosial)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/sosial/{{ $sosial->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                                        data-feather="eye"></span></a>
                                            </td>
                                ...
                                <tbody>
                                    @foreach ($pengamanans as $pengamanan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/pengamanan/{{ $pengamanan->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                                        data-feather="eye"></span></a>
                                            </td>
            ...
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4 class="col-12"><strong>Identifikasi Tingkat Kerawanan Keamanan</strong></h4>
                            </div>
                            <table class="datatables-basic table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($kerawanans as $kerawanan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/kerawanan/{{ $kerawanan->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                                        data-feather="eye"></span></a>
                                            </td>
                                ...
                                <tbody>
                                    @foreach ($pelatihans as $pelatihan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/pelatihan/{{ $pelatihan->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                                        data-feather="eye"></span></a>
                                            </td>
            ...
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4 class="col-12"><strong>Pelaporan</strong></h4>
                            </div>
                            <table class="datatables-basic table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($lapors as $lapor)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="/lapor/{{ $lapor->id }}"class="btn btn-icon rounded-circle btn-outline-success btn-sm"><span
                                                        data-feather="eye"></span></a>
                                            </td>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-end">
                        <a href="/rekapkantorinduk" class="btn btn-bitbucket btn-md " target="blank">Generated Level</a>
                        <a href="/cetakinduk" class="btn btn-success btn-md " target="blank">Cetak Formulir</a>
                    </div>
                </div>
            </div>
            <br>
