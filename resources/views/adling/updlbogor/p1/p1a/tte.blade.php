@foreach ($terimabogors as $terimabogor)

<html>

<head>
    <title>Tanda Terima Eleltronik</title>
...
<body>
    ...
    <div>
        ...
        <img class="logo1" src="{{ public_path('/app-assets/images/pages/pln12.png') }}" width="18%">
    </div>
    ...
    <div id=border>
        ...
        <table>
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 79%;">{{ $dot }}-{{ $terimabogor->user->unit }}</td>
            </tr>
            <tr>
                <td style="width: 30%;"><strong>PERIODE TTE</strong></td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;"> {{ $terimabogor->wulan }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 5%;"> :</td>
                <td style="width: 65%;"> {{ $terimabogor->user->name }}</td>
            </tr>
            <tr>
                <td style="width: 30%;"><strong>NAMA UNIT</strong></td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{ $terimabogor->divisi }}</td>
            </tr>
            <tr>
                <td style="width: 30%; vertical-align: top;"><strong>ID UNIT</strong></td>
                <td style="width: 5%; vertical-align: top;">:</td>
                <td style="width: 65%;">{{ $terimabogor->user->unit }}</td>
            </tr>
            <tr>
                <td style="width: 30%;"><strong>Alamat</strong></td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{ $terimabogor->user->alamat }}</td>
            </tr>
        </table>
        <div class="barcode">
            <p></p>
