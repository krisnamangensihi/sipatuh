                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Surat Penyampaian Dokumen dan atau Tanda Terima</h4>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><span class="fw-bold">:
                                                                                    <a href="{{ asset('storage/' . $p7a->berkas) }}"
                                                                                        target="blank">Lampiran <i
                                                                                            data-feather="file"></i>
                                                                                    </a>
                                                                                    <a href="{{ asset('storage/' . $p7a->foto) }}"
                                                                                        target="blank">Bukti <i
                                                                                            data-feather="file"></i>
                                                                                    </a>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/palembang7a/{{ $p7a->id }}"
                                                                        method="POST">
                                                                        @method('put')
                                                                        @csrf <div class="mb-2">
