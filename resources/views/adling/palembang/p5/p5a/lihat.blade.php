                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Pengelolaan Limbah B3</h4>
                                </div>
                                <div class="card-body">
                                                            ...
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        @foreach ($p5adocs as $p5adoc)
                                                                            <tr>
                                                                                <td class="pe-1">
                                                                                    {{ $p5adoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                        <a href="{{ asset('storage/' . $p5adoc->berkas) }}"
                                                                ...
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/palembang5a/{{ $p5a->id }}"
                                                                        method="POST">
                                                                        @method('put')
                                                                        @csrf <div class="mb-2">
