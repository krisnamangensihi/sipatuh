                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Inspeksi, Pengawasan dan Sanki Hukum pencemaran
                                        (Ketidakpatuhan) Lingkungan</h4>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><span class="fw-bold">:
                                                                                    <a href="{{ asset('storage/' . $p6a->berkas) }}"
                                                                ...
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/palembang6a/{{ $p6a->id }}"
                                                                        method="POST">
                                                                        @method('put')
                                                                        @csrf <div class="mb-2">
