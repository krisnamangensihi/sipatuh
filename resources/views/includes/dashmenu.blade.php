    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a class="dropdown-item d-flex align-items-center" href="{{ route('home') }}"
                        data-bs-toggle="" data-i18n="Modals"><i data-feather="home"></i><span
                            data-i18n="Modals">Dashboard</span></a>
                </li>
            </ul>
        </div>
    </div>
