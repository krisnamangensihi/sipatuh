                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                                ...
                                                <div class="card invoice-preview-card">
                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                           <form action="/verifikasi/{{ $leadership->id }}" method="POST" enctype="multipart/form-data">
                                                                        @method('put')
                                                                        @csrf 
                                    <div class="mb-1 col-md-12">
                                        <label class="form-label" for="inputfile">Silahkan Masukan File</label>
                                        <input class="form-control" type="file" id="inputfile" name="document" />
                                    </div>
                                ...
                                <input type="hidden" value="{{ Auth::user()->unit }}" name="nip">
                                               <button type="hidden" value="tw2" name="verifikasi" class="btn btn-success" id="type-verifikasi"
