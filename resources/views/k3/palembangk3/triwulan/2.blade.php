                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $leadership->triwulan }}</td>
  ...
  <div class="row">
    <div class="col text-end">
       ...
       <button class="btn btn-success">Verifikasi</button>
        @elseif ($leader->triwulan=="2")
        <form action="/bogork3/{{ $leadership->id }}/edit" >
                   <a  href="/bogork3/{{ $leadership->id }}"class="btn btn-icon rounded-circle btn-outline-primary btn-sm"><span data-feather="eye"></span></a>
        @if ($leader->triwulan=="1")
        <input type="hidden" value="tw1" name="tw"/>                                               
        @elseif ($leader->triwulan=="2")
        <input type="hidden" value="tw2" name="tw"/>                                               
        @elseif ($leader->triwulan=="3")
        <input type="hidden" value="tw3" name="tw"/>                                               
        @elseif ($leader->triwulan=="4")
        <input type="hidden" value="tw4" name="tw"/>                                               
        @endif                                            
        ...
        <a href="/rekapdatabogortw2" class="btn btn-primary btn-md " target="blank">Generated Level</a>
        @elseif ($verifikasi->verifikasi=="tw3")
        <a href="/rekapdatabogortw3" class="btn btn-primary btn-md " target="blank">Generated Level</a>
        @elseif ($verifikasi->verifikasi=="tw4")
        <a href="/rekapdatabogortw4" class="btn btn-primary btn-md " target="blank">Generated Level</a>
        @endif
