...
<body>
    ...
    @php
        $ldate = date('d-m-Y');
        $dot = date('ymd');
        $tgl_pertama = date('Y-m-01', strtotime($leader->tgl_pelaporan));
        $tgl_terakhir = date('Y-m-t', strtotime($leader->tgl_pelaporan));
    @endphp
	<table width="100%">
   ...
   <table>
       <tr>
            ...
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{ $tgl_pertama }} - {{ $tgl_terakhir }}</td>
            </tr>
            <tr>
