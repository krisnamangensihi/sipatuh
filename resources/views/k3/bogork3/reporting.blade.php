                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:
                                                                                {{ $reporting->no_kriteria }}. {{ $reporting->sub_kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        @foreach ($reportingdocs as $reportingdoc)
                                                                        <tr>
                                                                                    
                                                                                <td class="pe-1">{{ $reportingdoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                <a href="{{ asset('storage/' . $reportingdoc->document) }}" target="blank">document <i data-feather="file"></i> </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
                                                                            <td class="pe-1">Catatan</td>
                                                                            <td>: {{ $reporting->catatan }}
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/reporting/{{ $reporting->id }}" method="POST">
                                                                        @method('put')
                                                                        @csrf      <div class="mb-2">
