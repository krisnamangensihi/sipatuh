                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>: {{ $leadership->user->name }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="pe-1">Divisi</td>
                                                                            <td>: {{ $leadership->divisi }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="pe-1">Kriteria</td>
                                                                            <td>:
                                                                              {{ $leadership->no_kriteria }}. {{ $leadership->sub_kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/pengajuandiajukan/{{ $leadership->id }}" method="POST">
                                                                        @method('put')
                                                                        @csrf      <div class="mb-2">
