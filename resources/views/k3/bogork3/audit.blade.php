                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:
                                                                               {{ $audit->no_kriteria }}. {{ $audit->Sub_Kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        @foreach ($auditdocs as $auditdoc)
                                                                        <tr>
                                                                                    
                                                                                <td class="pe-1">{{ $auditdoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                <a href="{{ asset('storage/' . $auditdoc->document) }}" target="blank">document <i data-feather="file"></i> </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
                                                                ...
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/auditdiajukan/{{ $audit->id }}" method="POST">
                                                                        @method('put')
                                                                        @csrf      <div class="mb-2">
