                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            <div class="col-xl-8 p-0">
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:
                                                                                {{ $penerapan->no_kriteria }}. {{ $penerapan->sub_kriteria }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        @foreach ($penerapandocs as $penerapandoc)
                                                                        <tr>
                                                                                    
                                                                                <td class="pe-1">{{ $penerapandoc->keterangan }}</td>
                                                                                <td><span class="fw-bold">:
                                                                                <a href="{{ asset('storage/' . $penerapandoc->document) }}" target="blank">document <i data-feather="file"></i> </a>
                                                                            </td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
                                                                            <td class="pe-1">Catatan</td>
                                                                            <td>: {{ $penerapan->catatan }}
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <br>
                                                                <div class="col-sm-9 ">
                                                                    <form action="/penerapan/{{ $penerapan->id }}" method="POST">
                                                                        @method('put')
                                                                        @csrf      <div class="mb-2">
                                                                        ...
                                                                        <a href="/dashboardk3" class="btn btn-gradient-danger btn-sm">Back</a>
