    ...
    <div class="col text-end">
      @if (is_null($leader))
       <button class="btn btn-success">Verifikasi</button>
        ...
        @if ($verifikasi->verifikasi=="tw3")
        <a href="/rekapdatapadangtw1" class="btn btn-primary btn-md " target="blank">Generated Level</a>
        @elseif ($verifikasi->verifikasi=="tw0")
        <button type="button" id="type-dikasihinfo" class="btn btn-primary btn-md ">Generated Level</button>
