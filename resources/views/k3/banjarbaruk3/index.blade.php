                    ...
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            <button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="grid"></i></button>
                             <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="/cetakpdfpadang" target="blank"><i class="me-1" data-feather="check-square"></i><span class="align-middle">Cetak Pdf</span></a>
                                <a class="dropdown-item" href="/rekapdatabanjarbaru"><i class="me-1" data-feather="check-square"></i><span class="align-middle">Generated Level</span></a>
