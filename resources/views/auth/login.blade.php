            ...
            <div class="content-body">
                <div class="auth-wrapper auth-cover">
                    <!-- Brand logo--><a class="brand-logo" href="#">
                        <img class="image" border="0" src="../../../app-assets/images/pages/bumn1.png"
                            width="160px" height="40" style="margin:0px 0px 0px -5%;padding: 0px;">
                        <img class="image" border="0" src="../../../app-assets/images/pages/hsse1.png"
                            width="45px" height="60" style="margin: -15px 300px 0px 200px;padding: 0px;">
                        <img class="image" border="0" src="../../../app-assets/images/pages/pln1.png"
                            width="120px" height="40" style="margin: 0px 0px 0px 0%;padding: 0px;">
                    </a>
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="../../../app-assets/images/pages/bapakpln 1.png"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <center>
                                    <img class="image" border="0"
                                        src="../../../app-assets/images/pages/patuh123 1.png" width="300px"
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label"
                                                for="login-password">{{ __('Password') }}</label>
                                        </div>
