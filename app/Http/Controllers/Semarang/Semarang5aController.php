...
class Semarang5aController extends Controller
{
    /**
    ...
    {
        //
        return view('adling.semarang.p5.p5a.p5a',[
            'p5as'=>P5a::select()->where('divisi','PT. PLN (Persero) UPDL SEMARANG')->get(),
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('adling.semarang.p5.p5a.lihat',[
