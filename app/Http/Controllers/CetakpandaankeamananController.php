...
class CetakpandaankeamananController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pdf=PDF::loadview ('keamanan.pandaankeamanan.pdf', compact('kepemimpinan','sosial','pengamanan','user','kerawanan','pelatihan','lapor'));
