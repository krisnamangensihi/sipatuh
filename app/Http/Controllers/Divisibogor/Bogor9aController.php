...
class Bogor9aController extends Controller
{
    /**
    ...
    {
        //
        return view('adling.updlbogor.p9.p9a',[
            'p9as'=>P9a::select()->where('divisi','PT. PLN (Persero) UPDL BOGOR')->get(),
        ]);
    }
    ...
    {
        //
        return view('adling.updlbogor.p9.lihat',[
