...
class CetakmakasarkeamananController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pdf=PDF::loadview ('keamanan.makasarkeamanan.pdf', compact('kepemimpinan','sosial','pengamanan','user','kerawanan','pelatihan','lapor'));
