            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">PPL & DPL</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">Program Pelestarian Lingkungan dan Digitalisasi Pengelolaan Lingkungan PLN Grup
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Program Pelestarian Lingkungan dan Digitalisasi Pengelolaan Lingkungan PLN Grup</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/point8a" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="invalid-feedback">Pilih Jenis</div>
                                ...
                                <section id="form-control-repeater">
                                    <div class="invoice-repeater">
                                        <div data-repeater-list="point8doc">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    @foreach ($point8s as $point8)
                                        <tr>
                                            <td></td>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td class="text-center">{{ $point8->nomer_surat }}</td>
                                            <td class="text-center">{{ $point8->perihal }}</td>
                                            <td class="text-center">{{ $point8->wulan }}</td>
                                            <td class="text-center">{{ $point8->bulan }}</td>
                                            <td class="text-center">{{ $point8->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/point8a/{{ $point8->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/point8a/{{ $point8->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 3%"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/point8a/{{ $point8->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
