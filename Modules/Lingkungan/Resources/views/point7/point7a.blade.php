                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Pelaporan Lingkungan Hidup</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/point7a" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <select class="form-select" id="jenis" name="jenis">
                                        ...
                                        <option value="Surat Penyampaian Dokumen dan atau Tanda Terima">Surat Penyampaian
                                            Dokumen dan atau Tanda Terima</option>
                                        <option value="Sertifikat Hasil Uji">Sertifikat Hasil Uji</option>
                                        <option value="Laporan Neraca LB3">Laporan Neraca LB3</option>
                                    </select>
                                ...
                                <section id="form-control-repeater">
                                    <div class="invoice-repeater">
                                        <div data-repeater-list="point7doc">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    {{-- @if (!empty($point1s)) --}}
                                    @foreach ($point7s as $point7)
                                        <tr>
                                            <td></td>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td class="text-center">{{ $point7->jenis }}</td>
                                            <td class="text-center">{{ $point7->nomer_surat }}</td>
                                            <td class="text-center">{{ $point7->perihal }}</td>
                                            <td class="text-center">{{ $point7->wulan }}</td>
                                            <td class="text-center">{{ $point7->bulan }}</td>
                                            <td class="text-center">{{ $point7->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/point7a/{{ $point7->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/point7a/{{ $point7->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 3%"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/point7a/{{ $point7->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
