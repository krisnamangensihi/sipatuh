                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Porgram Pelestarian Lingkungan dan Digitalisasi Pengelolaan Lingkugan PLN Grup
                                    </li>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Porgram Pelestarian Lingkungan dan Digitalisasi Pengelolaan Lingkugan PLN Grup
                                </h3>
                                <div class="mb-1">
                                    <p><a href="https://docs.google.com/spreadsheets/d/1i7r-_PyK3iWiKYF0CZKEa1_1JPwPQqt5/edit?usp=sharing&ouid=104644451334503581170&rtpof=true&sd=true"
                                            target="blank"><strong>Unduh Form Peletarian Lingkungan Disini</strong></a>
                                    </p>
                                </div>
                                {{-- <p class="address-subtitle text-center mb-2 pb-75"></p> --}}

                                <form action="/Lingkungan/p8a" method="POST" enctype="multipart/form-data" id="addNewAddressForm"
                                    class="row gy-1 gx-2">
                                    @csrf
                                    <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($p8as as $p8a)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p8a->berkas) }}" target="blank"
