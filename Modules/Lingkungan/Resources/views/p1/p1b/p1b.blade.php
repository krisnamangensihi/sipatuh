                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">DokLing dan IL</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/p1b" method="POST" enctype="multipart/form-data" id="addNewAddressForm"
                                class="row gy-1 gx-2">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12 col-md-12">
                                    <label class="form-label" for="nomer_surat">Nomor Surat</label>
                                ...
                                <tbody>
                                    @foreach ($p1bs as $p1b)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p1b->berkas) }}" target="blank"
