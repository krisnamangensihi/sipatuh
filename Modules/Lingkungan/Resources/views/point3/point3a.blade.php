...
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">PPAU</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">Pelaksanaan Pengelolaan dan
    ...
    <div class="card card-payment">
        <div class="card-header">
            <h4 class="card-title">Pelaksanaan Pengelolaan Perubahan Iklim</h4>
        ...
        <div class="card-body">
            ...
            <form action="/Lingkungan/point4a" method="POST" class="form"
                ...
                <div class="row">
                    ...
                    <section id="form-control-repeater">
                            <div class="invoice-repeater">
                                <div data-repeater-list="point4doc">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Pelaksanaan Pengelolaan dan
                                Pengendalian Pencemaran Air dan Udara</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/point3a" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <select class="form-select" id="jenis" name="jenis">
                                        <option value="">-Pilih-</option>
                                        <option value="Pengendalian Pencemaran Air">Pengendalian Pencemaran Air</option>
                                        <option value="Pengendalian pencemaran Udara">Pengendalian pencemaran Udara</option>
                                        <option value="Pemenuhan CEMS, SISPEK, BME">Pemenuhan CEMS, SISPEK, BME</option>
                                        <option value="Pemenuhan Emisi GRK">Pemenuhan Emisi GRK</option>
                                    </select>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <section id="form-control-repeater">
                                    <div class="invoice-repeater">
                                        <div data-repeater-list="point3doc">
                                            <div data-repeater-item>
                                                <div class="row d-flex align-items-end">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($point3s as $point3)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $point3->wulan }}</td>
                                            <td class="text-center">{{ $point3->bulan }}</td>
                                            <td class="text-center">{{ $point3->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/point3a/{{ $point3->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/point3a/{{ $point3->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 5%"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/point3a/{{ $point3->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
