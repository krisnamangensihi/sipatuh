                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pelaporan Kepatuhan Kinerja Lingkungan Hidup ke Kantor Induk
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Pelaporan Kepatuhan Kinerja Lingkungan Hidup ke Kantor Induk</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/p9a" method="POST" enctype="multipart/form-data"
                            ...
                            <table class="datatables-basic table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" colspan="1">Triwulan</th>
                                ...
                                <tbody>
                                    @foreach ($p9as as $p9a)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p9a->berkas) }}" target="blank"
