            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Kepatuhan Kinerja</h2>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            ...
                            <form action="/Lingkungan/point9a" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="invalid-feedback">Pilih Jenis</div>
                                ...
                                <section id="form-control-repeater">
                                    <div class="invoice-repeater">
                                        <div data-repeater-list="point9doc">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    @foreach ($point9s as $point9)
                                        <tr>
                                            <td></td>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td class="text-center">{{ $point9->nomer_surat }}</td>
                                            <td class="text-center">{{ $point9->perihal }}</td>
                                            <td class="text-center">{{ $point9->wulan }}</td>
                                            <td class="text-center">{{ $point9->bulan }}</td>
                                            <td class="text-center">{{ $point9->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/point9a/{{ $point9->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/point9a/{{ $point9->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 3%"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/point9a/{{ $point9->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
