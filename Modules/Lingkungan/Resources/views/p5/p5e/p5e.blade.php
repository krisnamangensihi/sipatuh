                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Logbook
                                </h3>
                                <div class="mb-1">
                                    <p><a href="https://docs.google.com/spreadsheets/d/1IxF_C9dVH2uwtdGEbXMV2hBFMyK9eDQJ/edit?usp=sharing&ouid=104644451334503581170&rtpof=true&sd=true"
                                            target="blank"><strong>Unduh Format Logbook Disini</strong></a>
                                    </p>
                                </div>
                                {{-- <p class="address-subtitle text-center mb-2 pb-75"></p> --}}

                                <form action="/Lingkungan/p5e" method="POST" enctype="multipart/form-data" id="addNewAddressForm"
                                    class="row gy-1 gx-2">
                                    @csrf
                                    <div class="col-12">
                                    ...
                                    {{-- <div class="col-12 col-md-12">
                                        ...
                                        <input type="text" id="periode" name="periode" class="form-control"
                                            placeholder="Periode" aria-label="Periode"
                                            aria-describedby="periode" />
                                    </div> --}}
                                ...
                                <tbody>
                                    @foreach ($p5es as $p5e)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p5e->berkas) }}" target="blank"
