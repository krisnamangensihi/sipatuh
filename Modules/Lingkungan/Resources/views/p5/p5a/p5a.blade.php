                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pengelolaan Limbah B3
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Pengelolaan Limbah B3
                                </h3>
                                <div class="mb-1">
                                    <p><a href="https://docs.google.com/spreadsheets/d/1GZ3bxqpRaV2UgX-CVQbuVdhyuBUZo8VP/edit?usp=sharing&ouid=104644451334503581170&rtpof=true&sd=true"
                                            target="blank"><strong>Unduh Format Form SA PLB3 Disini</strong></a>
                                    </p>
                                </div>
                                {{-- <p class="address-subtitle text-center mb-2 pb-75"></p> --}}

                                <form action="/Lingkungan/p5a" method="POST" enctype="multipart/form-data" id="addNewAddressForm"
                                    class="row gy-1 gx-2">
                                    @csrf
                                    <div class="col-12">
                                    ...
                                    {{-- <div class="col-xl-6 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input class="form-control" name="dokumen1" type="file" id="dokumen1"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12">
                                        <div class="mb-1">
                                            <label>SOP Tanggap Darurat</label>
                                            <input class="form-control" name="dokumen2" type="file" id="dokumen2"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12">
                                        <div class="mb-1">
                                            <label>Prosedur Penanganan Limbah</label>
                                            <input class="form-control" name="dokumen3" type="file" id="dokumen3"
                                                required>
                                        </div>
                                    </div>
                            ...
                            <table class="datatables-basic table">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th class="text-center">Pendukung</th> --}}
                                ...
                                <tbody>
                                    @foreach ($p5as as $p5a)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $p5a->perihal }}</td>
                                            {{-- <td class="text-center">{{ $p5a->dok }}</td> --}}
                                            {{-- <td class="text-center">{{ $p5a->divisi }}</td> --}}
                                            <td class="text-center">{{ $p5a->wulan }}</td>
                                            {{-- <td class="text-center">{{ $p5a->bulan }}</td> --}}
                                            <td class="text-center">{{ $p5a->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                @if ($p5a->status == 'diajukan')
                                                    <span class="badge rounded-pill  badge-light-info">Diajukan</span>
                                                @elseif ($p5a->status == 'disetujui')
                                                    <span class="badge rounded-pill  badge-light-success">Disetujui</span>
                                                @elseif ($p5a->status == 'direvisi')
                                                    <span class="badge rounded-pill  badge-light-warning">Revisi</span>
                                                @elseif ($p5a->status == 'ditindak')
                                                    <span class="badge rounded-pill  badge-light-primary">Tindak Lanjut</span>
                                                @elseif ($p5a->status == 'ditolak')
                                                    <span class="badge rounded-pill  badge-light-danger">Ditolak</span>
                                                @endif
                                            </td>
                                            <td class="text-center">{{ $p5a->catatan }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/p5a/{{ $p5a->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/p5a/{{ $p5a->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 3px 0px"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/p5a/{{ $p5a->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
