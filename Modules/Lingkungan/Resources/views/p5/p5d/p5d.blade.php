                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-4 mx-50">
                                <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Kontrak dan MoU Kerjasama
                                </h3>
                                <div class="mb-1">
                                    {{-- <p><a href="https://drive.google.com/drive/folders/1BbNgC_ARDu9nYiT9-3rr2MqXnIhnCcfN?usp=sharing"
                                            target="blank"><strong>Unduh Format Form SA Disini</strong></a>
                                    </p> --}}
                                </div>
                                {{-- <p class="address-subtitle text-center mb-2 pb-75"></p> --}}

                                <form action="/Lingkungan/p5d" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="nomer_surat">Nomor Kontrak</label>
                                        <input type="text" id="nomer_surat" name="nomer_surat" class="form-control"
                                            placeholder="Nomor Surat" aria-label="Nomor Surat"
                                    ...
                                    {{-- <div class="col-12 col-md-12">
                                        ...
                                        <input type="text" id="perihal" name="perihal" class="form-control"
                                            placeholder="Perihal" aria-label="Perihal" aria-describedby="perihal" />
                                    </div> --}}
                                    ...
                                    {{-- <div class="col-12 col-md-12">
                                        ...
                                        <input type="text" id="periode" name="periode" class="form-control"
                                            placeholder="Periode" aria-label="Periode" aria-describedby="periode" />
                                    </div> --}}


                                    <div class="col-md-12 mb-1">
                                        <label class="form-label" for="periode">Periode</label>
                                        <input type="text" id="periode" name="periode" class="form-control flatpickr-range" placeholder="YYYY-MM-DD to YYYY-MM-DD" />
                                    </div>
                                ...
                                <tbody>
                                    @foreach ($p5ds as $p5d)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p5d->berkas) }}" target="blank"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/p5d/{{ $p5d->id }}/edit"
                                                    class="btn btn-icon btn-warning"  style="margin: 3px 0px"><span data-feather="edit"></span></a>
