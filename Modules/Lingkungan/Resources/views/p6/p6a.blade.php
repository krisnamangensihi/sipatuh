                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">Inspeksi, Pengawasan dan
                                Sanki Hukum pencemaran (Ketidakpatuhan) Lingkungan</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/p6a" method="POST" enctype="multipart/form-data"
                                ...
                                <tbody>
                                    @foreach ($p6as as $p6a)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p6a->berkas) }}" target="blank"
