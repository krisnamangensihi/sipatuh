                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pelaksanaan Pengelolaan
                                        Perubahan Iklim
                                    </li>
                                </ol>
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            ...
                            <form action="/Lingkungan/point4a" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    {{-- @if (!empty($point1s)) --}}
                                    @foreach ($point4s as $point4)
                                        <tr>
                                            <td></td>
                                            <td class="text-center">{{ $loop->iteration }}</td>
                                            <td class="text-center">{{ $point4->nomer_surat }}</td>
                                            <td class="text-center">{{ $point4->perihal }}</td>
                                            <td class="text-center">{{ $point4->divisi }}</td>
                                            <td class="text-center">{{ $point4->wulan }}</td>
                                            <td class="text-center">{{ $point4->bulan }}</td>
                                            <td class="text-center">{{ $point4->tanggal_dibuat }}</td>
                                            <td class="text-center">
                                                <a href="/Lingkungan/point4a/{{ $point4->id }}"
                                                    class="btn btn-icon btn-success"><span data-feather="eye"></span></a>
                                                <a href="/Lingkungan/point4a/{{ $point4->id }}/edit"
                                                    class="btn btn-icon btn-warning" style="margin: 3%"><span
                                                        data-feather="edit"></span></a>

                                                <form action="/Lingkungan/point4a/{{ $point4->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
