                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-4 mx-50">
                            <h3 class="address-title text-center mb-1" id="addNewAddressTitle">PPA_Air Laut</h3>
                            <p class="address-subtitle text-center mb-2 pb-75"></p>

                            <form action="/Lingkungan/p2a" method="POST" enctype="multipart/form-data"
                                ...
                                <tbody>
                                    @foreach ($p2as as $p2a)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ asset('storage/' . $p2a->berkas) }}" target="blank"
