                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                <h4 class="card-title">Safety Campaign and Communication</h4>
                            </div>
                            <div class="card-body">

                                <form action="/K3/comunication" method="POST" class="form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="sub_kriteria" name="sub_kriteria">
                                                <option>silahkan isi sub kriteria</option>
                                                                               <option value="Melaksanakan Rapat P2K3">Melaksanakan Rapat P2K3</option>
                                                <option value=" Melakukan Edukasi dan Upaya Pencegahan Kecelakaan Masyarakat Umum"> Melakukan Edukasi dan Upaya Pencegahan Kecelakaan Masyarakat Umum</option>
                                       ...
                                       <div class="mb-1">
                                           ...
                                           <select class="form-select" id="divisi" name="divisi">
                                                <option>-Pilih-</option>
                                                <option value="PT. PLN (Persero) UPDL BANJARBARU">PT. PLN (Persero) PT. PLN (Persero) UPDL BANJABARU</option>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                                                    <div class="mb-1">
                                                                        <label for="tgl_pelaporan" class="form-label"><b>Tanggal Pelaporan</b></label>
                                        ...
                                        <section id="form-control-repeater">
                                            <div class="row">
                                                <div class="invoice-repeater">
                                                    <div data-repeater-list="comunicationdoc">
