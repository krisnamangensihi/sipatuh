                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                <h4 class="card-title">Penerapan Identifikasi Bahaya, Penilaian dan Pengendalian Risiko</h4>
                            </div>
                            <div class="card-body">

                                <form action="/K3/penerapan" method="POST" class="form"
                                        ...
                                        <section id="form-control-repeater">
                                            <div class="row">
                                                <div class="invoice-repeater">
                                                    <div data-repeater-list="penerapandoc">
