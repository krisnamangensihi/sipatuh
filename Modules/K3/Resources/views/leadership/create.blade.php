            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0"><b>Tambah Data</b></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                <h4 class="card-title">Leadership & Management Commitment</h4>
                            </div>
                            <div class="card-body">

                                <form action="/K3/leadership" method="POST" class="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <!-- full Editor start -->
                                        <div class="mb-1">
                                            <label class="form-label" for="triwulan"> <b>Triwulan</b></label>
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="no_kriteria"> <b>No kriteria</b></label>
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="sub_kriteria"><b>Sub Kriteria</b></label>
                                            <select class="form-select" id="sub_kriteria" name="sub_kriteria">
                                                ...
                                                <option value="Menerapan Contractor Safety Management System (CSMS)">
                                                    Menerapan Contractor Safety Management System (CSMS)</option>
                                                <option value="Membangun Sistem Manajemen K3 Terintegrasi">Membangun Sistem
                                                    Manajemen K3 Terintegrasi</option>

                                            </select>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="level"><b>Level</b></label>
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="divisi"><b>Unit</b></label>
                                            <select class="form-select" id="divisi" name="divisi">
                                                <option>-Pilih-</option>
                                                <option value="PT. PLN (Persero) UPDL BANJARBARU">PT. PLN (Persero) UPDL
                                                    BANJABARU</option>
                                                <option value="PT. PLN (Persero) UPDL BOGOR">PT. PLN (Persero) UPDL BOGOR
                                                </option>
                                                <option value="PT. PLN (Persero) UPDL JAKARTA">PT. PLN (Persero) UPDL
                                                    JAKARTA</option>
                                                <option value="PT. PLN (Persero) UPDL MAKASAR">PT. PLN (Persero) UPDL
                                                    MAKASAR</option>
                                                <option value="PT. PLN (Persero) UPDL PADANG">PT. PLN (Persero) UPDL PADANG
                                                </option>
                                                <option value="PT. PLN (Persero) UPDL PALEMBANG">PT. PLN (Persero) UPDL
                                                    PALEMBANG</option>
                                                <option value="PT. PLN (Persero) UPDL PANDAAN">PT. PLN (Persero) UPDL
                                                    PANDAAN</option>
                                                <option value="PT. PLN (Persero) UPDL SEMARANG">PT. PLN (Persero) UPDL
                                                    SEMARANG</option>
                                                <option value="PT. PLN (Persero) UPDL SURALAYA">PT. PLN (Persero) UPDL
                                                    SURALAYA</option>
                                                <option value="PT. PLN (Persero) UPDL TUNTUNGAN">PT. PLN (Persero) UPDL
                                                    TUNTUNGAN</option>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                <label for="tgl_pelaporan" class="form-label"><b>Tanggal
                                                        Pelaporan</b></label>
                                                <input class="form-control" name="tgl_pelaporan" type="date"
                                                    id="tgl_pelaporan">
                                                <input type="hidden" name="thn_pembuatan" value="{{ $ldate }}">
                                                <input type="hidden" name="verifikasi" value="tw0">
                                            </div>
                                        </div>
                                        <!-- full Editor end -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div>
                                                            <button class="btn btn-success" id="type-success"
                                                                onclick="return confirm('Apakah anda yakin dengan data anda?')">Simpan
                                                                & Ajukan</button>
                                                        </div>
                                                    </div>
                                                </div>
