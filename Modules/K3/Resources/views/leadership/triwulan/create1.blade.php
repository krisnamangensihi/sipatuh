                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/K3/leadership" method="POST" class="form"
                                       ...
                                       <div class="mb-1">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="hidden" name="catatan" value="*blank*">
                                                                    </div>
                                                                </div>
                                        <!-- full Editor end -->
                                            ...
                                            <div class="row">
                                                <div class="invoice-repeater">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div>
                                                            <button type="hidden" value="1" name="triwulan" class="btn btn-success" id="type-success"
