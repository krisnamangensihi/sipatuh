...
<head>
    ...
    <title>Laporan Maturity Level Keamanan</title>
    <link rel="apple-touch-icon" href="../../../app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="../../../app-assets/images/pages/hsse.jpeg">
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <!-- BEGIN: Header-->
    @include('keamanan::includes.header')
    <!-- END: Header-->


    <!-- BEGIN: Main Menu-->
    @include('keamanan::includes.menu')
    <!-- END: Main Menu-->
    ...
    <!-- BEGIN: Page JS-->
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/scripts/forms/form-repeater.js">
        < /scrip <!--BEGIN: Page JS-- >
            <
            script src = "../../../app-assets/js/scripts/forms/form-wizard.js" >
    </script>
    <!-- END: Page JS-->
