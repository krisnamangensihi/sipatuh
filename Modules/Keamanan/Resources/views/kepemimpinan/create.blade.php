                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                ...
                                <div class="mb-1">
                                    <a href="https://docs.google.com/spreadsheets/d/1f-VYuHWBnREOrFONzpMXHjwcptzGFoyI/edit?usp=sharing&ouid=106398647279345255972&rtpof=true&sd=true"
                                        target="blank">
                                        <strong>1.2 FORM INSPEKSI KEAMANAN (KAM)</strong>
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">

                                <form action="/Keamanan/kepemimpinan" method="POST" class="form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="no_kriteria" name="no_kriteria">
                                                <option>Pilih No Kriteria</option>
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="sub_kriteria"><b>Kriteria</b></label>
                                            <select class="form-select" id="sub_kriteria" name="sub_kriteria">
                                                <option>Pilih Kriteria</option>
                                                <option value="Penyusunan RKAP bidang Keamanan">Penyusunan RKAP bidang
                                                    Keamanan</option>
                                                <option
                                                    value="Komitmen Manajemen dan Manajemen menjadi Role Model Keamanan">
                                                    Komitmen Manajemen dan Manajemen menjadi Role Model Keamanan</option>
                                                <option value="Penerapan Sistem Manajemen Pengamanan berbasis IT">Penerapan
                                                    Sistem Manajemen Pengamanan berbasis IT</option>
                                            </select>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="divisi" name="divisi">
                                                ...
                                                <option value="UPDL BANJARBARU">UPDL BANJARBARU</option>
                                        ...
                                        {{-- <div class="row">
                                            <div class="mb-1 col-md-3">
                                                <label class="form-label" for="tanggal"><b>Tanggal Dibuat</b></label>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                <label for="tanggal" class="form-label"><b>Tanggal
                                                        Pelaporan</b></label>
                                                ...
                                                <div data-repeater-list="kepemimpinandoc">
                                                    <div data-repeater-item>
                                                        <div class="row d-flex align-items-end">
                                                            <div class="col-xl-4 col-md-6 col-12">
                                                                <div class="mb-1">
                                                                    <label><strong></strong> Berkas</label>
                                    ...
                                    <button class="btn btn-success" id="type-success"
                                        onclick="return confirm('Apakah anda yakin?')">Kirim</button>
                                </form>
                    ...
                    <div class="bs-stepper vertical wizard-modern modern-vertical-wizard-example">
                        ...
                        <div class="bs-stepper-content">
                            <div id="account-details-vertical-modern" class="content" role="tabpanel" aria-labelledby="account-details-vertical-modern-trigger">
                                ...
                                <div class="d-flex justify-content-been">
                            ...
                            <div id="social-links-vertical-modern" class="content" role="tabpanel" aria-labelledby="social-links-vertical-modern-trigger">
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="vertical-modernitter"itter</label>
                                        <input type="text" id="vertical-modernitter" class="form-control" placeholder="https:/itter.com/abc" />
                                    </div>
                                    <div class="mb-1 col-md-6">
