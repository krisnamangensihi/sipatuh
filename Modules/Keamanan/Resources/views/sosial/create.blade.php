            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0"><strong>Tambah Data</strong></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card card-payment">
                            <div class="card-header">
                                <h4 class="card-title"><strong>Sosialisasi, Kordinasi, Kerjasama Lintas Sektoral Dan
                                        Kelembagaan
                                        Negara</strong></h4>
                            </div>
                            <div class="card-body">

                                <form action="/Keamanan/sosial" method="POST" class="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <!-- full Editor start -->
                                        <div class="mb-1">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" id="sub_kriteria" name="sub_kriteria">
                                                ...
                                                <option
                                                    ...
                                                    Perjanjian Kerjasama Pengamanan Dengan Kepolisian, Tentara Nasional
                                                    Indonesia, BIN/BINDA</option>
                                                <option value="Melakukan Sosialisasi dan Pola Komunikasi Sistem Pengamanan">
                                                    Melakukan Sosialisasi dan Pola Komunikasi Sistem Pengamanan</option>
                                            </select>
                                        </div>
                                        <div class="mb-1">
