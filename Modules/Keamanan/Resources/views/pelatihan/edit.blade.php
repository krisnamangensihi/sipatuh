                        ...
                        <div class="col-12 col-md-12 mt-2">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Kompetensi dan Pelatihan</h4>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="/Keamanan/datakeamanan/{{ $pelatihan->id }}"
                                            ...
                                            <div class="col-12 ">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="no_kriteria" name="no_kriteria" required
                                                        autofocus value="{{ old('no_kriteria', $pelatihan->no_kriteria) }}">
                                                        <option>{{ old('no_kriteria', $pelatihan->kriteria) }}</option>
                                                        <option value="5.1"
                                                            @if ($pelatihan->no_kriteria == '5.1') selected @endif>5.1</option>
                                                        <option value="5.2"
                                                            @if ($pelatihan->no_kriteria == '5.2') selected @endif>5.2</option>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="sub_kriteria" name="sub_kriteria"
                                                        required autofocus
                                                        value="{{ old('sub_kriteria', $pelatihan->sub_kriteria) }}"
                                                        placeholder="Keterangan">
                                                        <option value="">
                                                            {{ old('sub_kriteria', $pelatihan->sub_kriteria) }}</option>
                                                        <option
                                                            value="Melakukan Tindakan Pencegahan  Preemtif, Preventif dan Represif Pengamanan"
                                                            @if ($pelatihan->kriteria == 'Melakukan Tindakan Pencegahan  Preemtif, Preventif dan Represif Pengamanan') selected @endif>Melakukan
                                                            Tindakan Pencegahan Preemtif, Preventif dan Represif Pengamanan
                                                        </option>
                                                        <option value="Pencegahan Masuknya  Radikalisme "
                                                            @if ($pelatihan->kriteria == 'Pencegahan Masuknya  Radikalisme ') selected @endif>Pencegahan
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="level" name="level" required
                                                        autofocus value="{{ old('keterangan', $pelatihan->level) }}">
                                                        <option>{{ old('keterangan', $pelatihan->level) }}</option>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="status" name="status" required
                                                        autofocus value="{{ old('status', $pelatihan->status) }}">
                                                        <option>{{ old('status', $pelatihan->status) }} </option>
                                                        <option value="tindaklanjut">Tindak Lanjut</option>
                                                    </select>
                                                </div>
                                                <section id="form-control-repeater">
                                                    <div class="invoice-repeater">
                                                        <div data-repeater-list="pelatihandoc">
