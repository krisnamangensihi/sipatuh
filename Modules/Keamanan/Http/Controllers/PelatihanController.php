...
class PelatihanController extends Controller
{
    ...
    {
        return view('keamanan::pelatihan.create');
    }
    ...
    {
        $query=Pelatihan::select()->get()->count();
             $id=$query+1;
            Pelatihan::create([
                    'id'=>$id,
            ...
            foreach ($request->pelatihandoc as $key => $value) {
                if ($value['document']){
    ...
    public function show($id)
    {
        ...
        return view('keamanan::pelatihan.lihat',[
    ...
    {
        return view('keamanan::pelatihan.edit', [
